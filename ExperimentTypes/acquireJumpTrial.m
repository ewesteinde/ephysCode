function [rawData, trialData, trialMeta, behaviorData] = acquireJumpTrial(trialRepeats, trialLength, inR)
...
for t = 1:trialRepeats
    ...
    % Panels code
    openLoop(settings.panels.jumpPattern, settings.panels.jumpFunction,1);
    Panel_com('start');
