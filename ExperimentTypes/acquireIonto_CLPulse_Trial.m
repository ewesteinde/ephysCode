function [rawData_all, trialData, trialMeta, behaviorData, dirname] = acquireIonto_CLPulse_Trial(trialRepeats, stimLength, bufferLength)
...
trialMeta.daqChNames  = {niIO.Channels(:).Name};
    ...
    %run fictrac & closed loop pattern inbetween trials
